...
<div class="nav-bar bg-color-green">
    <div class="nav-bar-inner padding10">
        ...
        <a href="/pry"><span class="element brand">
            <!--<img class="place-left" src="images/logo32.png" style="height: 20px"/>-->
            Panel de control<small>&nbsp;&nbsp;Administrador</small>
        </span></a>
        ...
        <ul class="menu">
            ...
            <li data-role="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="/pry/mantenedores/index/persona">Persona</a></li>
                    <li><a href="/pry/mantenedores/index/region">Region</a></li>
                    <li><a href="/pry/mantenedores/index/comuna">Comuna</a></li>
                    <!--<li class="divider"></li>-->
                    <li><a href="/pry/mantenedores/index/dominio">Dominio</a>
                    </li>
                </ul>
            </li>
            <!--
